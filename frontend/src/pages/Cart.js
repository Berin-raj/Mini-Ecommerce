...
export default function Cart({cartItems,setcartItem}){
    ...
    return  cartItems.length>0 ?<Fragment>  <div class="container container-fluid">
        ...
        <div class="row d-flex justify-content-between">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 col-lg-3 mt-4 mt-lg-0">
                            <div class="stockCounter d-inline">
                                <span class="btn btn-danger minus" onClick={()=> decreaceQty(item)}>-</span>
                        ...
                        <div class="col-4 col-lg-1 mt-4 mt-lg-0">
                            <i id="delete_cart_item" onClick={()=> removeItems(item)} class="fa fa-trash btn btn-danger"></i>
                        </div>
           ...
           :<Fragment>
            <h2 className="mt-5">Order Completed!</h2><p>Your order has been recived</p>
            </Fragment>)
}